...
export default async function Header() {
  ...
  return (
    <header className='flex justify-between lg:grid lg:grid-cols-[20%_1fr] xl:grid-cols-[18%_1fr] 2xl:grid-cols-[16%_1fr] items-center py-[15px] px-[20px] lg:px-0 bg-[#141313]'>
